...
Each robot was run 5 times, starting from the same location each time. The robot was power-cycled between runs. Each run was recorded using rosbag, and the data from the recordings were used to generate \todo{MAKE YOU SOME FIGS FOR GREAT GOOD}. 
...
The green tank experienced problems with one side of its drive train in three of its five runs.
...
There are two blue tanks, carrying April tags #8 and #18. 
Tank #8 moved slightly on four of its 5 runs, and did not move on one of them. 
At no point did it move the full 0.25m. 
Tank #18 moved much more consistently, but displayed an arc to the right in four of its 5 runs. 
