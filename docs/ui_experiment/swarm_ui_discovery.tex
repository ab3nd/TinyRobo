...
Cohen's Kappa \todo{cite} is a measure of inter-coder reliaibility for categorical items, but it assumes that both coders are coding the same number of codable units. 
...
\todo{address Extending Cohen's Kappa by adding a null code for absent data? }

Krippendorf's Alpha \todo{cite} permits data to be absent. 
