...
%If you want to get really wiggy, behaviors could be hardwired in silicon using chip fab techniques for MEMS-based swarms, resulting in a enormous power savings over embedding a general-purpose computer and the software to run it in the machines. 
...
%TODO how multi-dimensional is this? Local sensing is a pretty wide range of things, from point sonar to full point clouds and object recognizers. Local communication is a range from explicit full messaging, to implicit forms like pheremones and stigmergy, identifiers are ... not as needed as I thought. 
