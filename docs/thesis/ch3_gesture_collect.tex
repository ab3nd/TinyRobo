...
\begin{figure}
	\begin{subfigure}{\textwidth}
		\centering
		\fbox{\includegraphics[width=0.4\textwidth]{../ui_experiment/slide_images/Swarm_Robot_Control_-_10_Robot_0004.png}}		
		\fbox{\includegraphics[width=0.4\textwidth]{../ui_experiment/slide_images/Swarm_Robot_Control_-_Single_Robot_0005.png}}
	\end{subfigure}
	\vspace{2mm}
	
	\begin{subfigure}{\textwidth}
		\centering
		\fbox{\includegraphics[width=0.4\textwidth]{../ui_experiment/slide_images/Swarm_Robot_Control_-_10_Robot_0005.png}}		
		\fbox{\includegraphics[width=0.4\textwidth]{../ui_experiment/slide_images/Swarm_Robot_Control_-_100_Robot_0005.png}}	
	\end{subfigure}
	\vspace{2mm}
	
	\begin{subfigure}{\textwidth}
		\centering
		\fbox{\includegraphics[width=0.4\textwidth]{../ui_experiment/slide_images/Swarm_Robot_Control_-_1000_Robot_0005.png}}		
		\fbox{\includegraphics[width=0.4\textwidth]{../ui_experiment/slide_images/Swarm_Robot_Control_-_Unknown_Number_of_Robots_0007.png}}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}{\textwidth}
		\fbox{\includegraphics[width=0.3\linewidth]{../ui_experiment/slide_images/Swarm_Robot_Control_-_Unknown_Number_of_Robots_0001.png}}
		\fbox{\includegraphics[width=0.3\linewidth]{../ui_experiment/slide_images/Swarm_Robot_Control_-_Unknown_Number_of_Robots_0002.png}}
		\fbox{\includegraphics[width=0.3\linewidth]{../ui_experiment/slide_images/Swarm_Robot_Control_-_Unknown_Number_of_Robots_0003.png}}
	\end{subfigure}
