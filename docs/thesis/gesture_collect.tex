...
Second, the timeout is could be invisible, resulting in a system that appears to do things for no reason, as far as the user is concerned. 
It could also be made visible, using a countdown timer, which may then make the user feel pressured to act. 

There are, however, limited instances where it is safe to assume that the user's command is complete. 
