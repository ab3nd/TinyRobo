...
\section{Potential Directions for Future Work}

\todo{Make this less of a notes section, maybe break out as a chapter}
...
User tests with a UI that doesn't depict swarm location at all
Depiction of density rather than location of single robots
...
Reference implementation of swarm robots
Swarm software reference implementations (cite refs calling for this)