...
MROBerTO, on the other hand, was designed to use color blob tracking by using a pair of LEDs on the top of the robot.
One centrally-located LED was uniquely colored to identify the robot, while the other, on the front edge of the robot, provided an indication of bearing. 
