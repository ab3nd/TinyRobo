...
The effect of the noise in subpixel position on the detected rotation of the tags is larger than its effect on the detected position of the tags, since rotation around the center of the tag does not change the position of its center at all. 
