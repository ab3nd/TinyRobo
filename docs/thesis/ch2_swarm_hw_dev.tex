...
\begin{table}
	...
	\end{tabular}\label{tab:per_robot_parts_cost}
...
Ultimately, the resulting swarm hardware platform does demonstrate that Hypothesis 1, that commodity hardware can enable the construction of a cheap indoor swarm, is correct. 
As seen in Table \ref{tab:per_robot_parts_cost}
