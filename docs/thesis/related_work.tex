...
\section{Swarm User Interface Designs}
...
\subsection{Multitouch UI Design Concerns}
...
\subsection{Existing Research on Swarm Controlability}
...
\subsection{Intel Drone Swarm Interface}
