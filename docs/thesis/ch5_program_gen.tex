...
\todo{clear up commented out section below}
%


%
%Once the robot is at the box, the robot circumnavigates it while detecting the points where the line between the robot's location and the goal (the m-line in the Bug2 algorithm) passes through the box. 
