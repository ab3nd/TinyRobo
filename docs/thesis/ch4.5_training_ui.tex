...
However, enforcing this kind of consistency may result in implementation of unneeded gestures that complicate the gesture space, such as being able to command only robots of a specific color to move a box, when the main concern is that the box be moved, not what color the robots doing the work are.  

Memorability
Reduction in total gestures made

Effectiveness of noobs