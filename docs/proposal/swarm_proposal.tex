...
The MarXbot swarm platform s capable of operating in unstructured human environments. 
...
Swarmanoid extends the interlinking mechanism of MarXbot to a heterogenous swarm with three different types of robots \cite{dorigo2013swarmanoid}.
The ``foot'' robots are MarXbots, and provide ground motion for ``hand'' robots. 
``hand'' have grippers to manipulate objects, and can also climb.
The hand robots have an attachement point like the MarXbots, and so can be carried by foot robots. 
