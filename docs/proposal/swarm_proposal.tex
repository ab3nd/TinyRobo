...
Multitouch gesture sets as a command language for controlling robots can be developed by an empirical process with naive users \cite{Micire:2009:ANG:1731903.1731912}. 
...
Swarm robot hardware design for integration with children's toys. 
ROS software for swarm virtualization. 
