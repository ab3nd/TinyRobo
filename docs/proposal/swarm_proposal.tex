...
The structure of the software framework is such that as available processing power on each individual robot increases, more of the processing can be handled locally, without changing the overall behavior of the system\improvement{Draw a diagram and put it here}.
...
Then virtualized failures. \improvement{Create some graphics of the proposed system.}
 
 - Write compiler. Figure out intermediate representation for language. Expression of desired states of robots and world after compilation. \unsure{How does this I don't even.} 
