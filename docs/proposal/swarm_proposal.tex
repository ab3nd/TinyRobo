...
Software - Write compiler. Figure out intermediate representation for language. Expression of desired states of robots and world after compilation. \unsure{How does this I don't even.} Start gesture compiler, chose IR, figure out parsing. Add failure parameters to virtual network and virtual sensors. 
