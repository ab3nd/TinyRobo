...
Decisions - How actions are taken, likelihood that the correct action is chosen \\
...
Compare to first data, and determine if combined data set has sufficient data to get useful results. 
