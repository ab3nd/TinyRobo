...
class UserData(object):
	...
	taskMap = {
		...
		"divide":{1:, 10:4, 100:4, 1000:4, 'X':4},
		"divide_color_1":{1:, 10:, 100:, 1000:, 'X':},
		"divide_color_2":{1:, 10:, 100:, 1000:, 'X':},
		"divide_color_mix":{1:, 10:, 100:, 1000:, 'X':},
		"split":{1:, 10:, 100:, 1000:, 'X':},
		"merge":{1:, 10:, 100:, 1000:, 'X':},
		"line":{1:, 10:, 100:, 1000:, 'X':},
		"square":{1:, 10:, 100:, 1000:, 'X':},
		"crate":{1:, 10:, 100:, 1000:, 'X':},
		"crate_dispersed":{1:, 10:, 100:, 1000:, 'X':},
		"mark":{1:, 10:, 100:, 1000:, 'X':},
		"remove":{1:, 10:, 100:, 1000:, 'X':},
		"patrol_screen":{1:, 10:, 100:, 1000:, 'X':},
		"patrol_a":{1:, 10:, 100:, 1000:, 'X':},
		"disperse":{1:, 10:, 100:, 1000:, 'X':}
	}